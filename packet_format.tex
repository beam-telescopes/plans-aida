...
\node [desc] (type) {Packet type};
% sizes
\chainin (marker); % Start right of Level 5
\node [size, right= of marker] (msize) {to be decided};
\node [size] (nsize) {60-bit};
\node [size] (tsize) {4-bit};
\draw[decorate,decoration={brace,mirror,raise=6pt,amplitude=10pt}, thick]
    (marker.north west)--(type.south west) node [midway] (hbrace){}; 
